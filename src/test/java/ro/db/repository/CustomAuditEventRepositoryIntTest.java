...
import ro.db.config.audit.AuditEventConverter;
import ro.db.domain.PersistentAuditEvent;
...
import static ro.db.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
