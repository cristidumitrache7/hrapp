package ro.db.web.rest;

import ro.db.config.Constants;
import ro.db.HrappApp;
import ro.db.domain.Authority;
import ro.db.domain.PersistentToken;
import ro.db.domain.User;
import ro.db.repository.AuthorityRepository;
import ro.db.repository.PersistentTokenRepository;
import ro.db.repository.UserRepository;
import ro.db.security.AuthoritiesConstants;
import ro.db.service.MailService;
import ro.db.service.dto.UserDTO;
import ro.db.web.rest.errors.ExceptionTranslator;
import ro.db.web.rest.vm.KeyAndPasswordVM;
import ro.db.web.rest.vm.ManagedUserVM;
import ro.db.service.UserService;
...
@SpringBootTest(classes = HrappApp.class)
